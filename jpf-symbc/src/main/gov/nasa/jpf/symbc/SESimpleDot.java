 ...
 */
public class SESimpleDot extends ListenerAdapter {
  ...
  protected String sourceLocation;//D.N.Thi
  protected PathCondition pc;//D.N.Thi
  ...
  public SESimpleDot( Config config, JPF jpf)
  {
  ...
  public void stateAdvanced(Search search)
  {
    ...
    sourceLocation = sourceLocation.substring(ix + 1, sourceLocation.length() - 1);
  ...
  protected void printTransition(String fromState, String toState, String choiceVal, String cgCause){
    ...
    pw.print(" [label=\"");
    //pw.print(choiceVal);
    pw.print(pc.toString());
    pw.print('"');
    if (cgCause != null){
      pw.print(NEW_EDGE_ATTRS);
      pw.print(",headlabel=\"");
      //pw.print(cgCause);
      pw.print(sourceLocation);//D.N.Thi            
      pw.print('"');
    } else {
