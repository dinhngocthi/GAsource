...
import gov.nasa.jpf.symbc.trie.Trie;
import gov.nasa.jpf.symbc.trie.TrieNodeType;
import gov.nasa.jpf.symbc.trie.Trie.TrieNode;
...
public class TrieBuilder extends ListenerAdapter 
{
	...
	private void writeObject() 
	{
		try 
		{
			...
			System.out.println("elapsed Time for serialization: " + elapsedTimeMillis);
		} 
		catch (Exception e) 
		{
			e.printStackTrace();
